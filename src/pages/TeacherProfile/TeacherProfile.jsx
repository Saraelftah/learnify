...
function TeacherProfile() {
  ...
  <div className="flex items-center gap-2">
    ...
    <span className="text-[var(--text-color)]">{teacher.subject} Teacher</span>
  </div>
</div>
                        {!isEditing && canEdit && (
                            <motion.button
                    ...
                    >
                        ...
                        <div className="mb-6 bg-[var(--light-background)] p-4 rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-[var(--dark-color)] font-bold">${teacher.hourlyRate}</span>
                            </div>
                            <div className="flex justify-between items-center mb-2">
                    ...
                    >
                        {isEditing ? (
                            ...
                            <motion.div
                                ...
                                className="space-y-6"
                            >
                                <h2 className="text-xl font-bold text-[var(--dark-color)]">Edit Profile</h2>
                                
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {['name', 'subject', 'gradeLevel', 'hourlyRate'].map((field) => (
                                        <motion.div
                                            key={field}
                                            variants={itemVariants}
                                        >
                                            <label className="block text-sm font-medium text-[var(--text-color)] mb-1">
                                                {field === 'hourlyRate' ? 'Hourly Rate ($)' : field.split(/(?=[A-Z])/).join(' ')}
                                            </label>
                                            <input
                                ...
                                <motion.div variants={itemVariants}>
                                    <label className="block text-sm font-medium text-[var(--text-color)] mb-1">Overview</label>
                                    <textarea
                                        name="overview"
                            ...
                            >
                                {/* About Section */}
                                <motion.div variants={itemVariants}>
                                    <h2 className="text-xl font-bold text-[var(--dark-color)] mb-3">ABOUT ME</h2>
                                    <p className="text-[var(--text-color)]">
                                        {teacher.overview || "I am a passionate educator dedicated to helping students achieve their full potential."}
                                    </p>
                                </motion.div>
...
<motion.div variants={itemVariants}>
    <h2 className="text-xl font-bold text-[var(--dark-color)] mb-3">Testimonials</h2>
        ...
        <p className="text-[var(--text-color)] italic">
            No reviews yet. Be the first to review this teacher!
                                ...
                                {teacher.availableDates?.length > 0 && (
                                    <motion.div variants={itemVariants}>
                                        <h2 className="text-xl font-bold text-[var(--dark-color)] mb-3">AVAILABILITY</h2>
