    ...
    <div className="contact-page pt-[100px] min-h-screen capitalize">
      ...
      <section className="hero-section" data-aos="fade-down">
        <div className="container mx-auto text-center py-5">
          <h3 className="text-[length:var(--title-font-size)] text-[var(--dark-color)] font-bold mb-6">
            Get In Touch
          </h3>
      ...
      <section className="contact-form py-10 bg-[var(--background-color)]">
        <div className="container">
          <div
            className="grid grid-cols-1 lg:grid-cols-2 gap-5 bg-[var(--card-background)] shadow-[var(--box-shadow)] p-5 rounded-[var(--border-radius)] items-center overflow-x-hidden"
            data-aos="zoom-in"
          >
