...
function AdminAnalysis() {
  ...
  return (
    <>
        <div className="admin-analysis w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 shadow-[var(--box-shadow)] capitalize mb-10  p-5">
            ...
            <div className="item text-center">
                <h4 className="text-[#84c6f9] font-bold text-2xl">
                    {(teachers?.reduce((acc, current)=>acc+Number(current.earning || 0),0))*.10}
                </h4>
                <p className="text-[var(--text-color)] mt-2">profit</p>
            </div>
            <div className="item text-center">
