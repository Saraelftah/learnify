...
function FeaturesCard({iconClass, description}) {
  return (
    <>
<<<<<<< HEAD
        <div className="item group shadow-xl py-6 rounded-[var(--border-radius)] flex flex-col justify-center items-center mt-2">
=======
        <div className="item group shadow-[var(--box-shadow)] py-6 rounded-[var(--border-radius)] flex flex-col justify-center items-center mt-2">
